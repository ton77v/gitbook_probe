...
This update extends support to Elasticsearch versions 9.0.2, 8.18.2, and 8.17.7, allowing users to secure their Elasticsearch clusters with ROR on these versions.
</details>
<details>
...
This fix resolves a specific issue encountered during the Elasticsearch patching process on Windows, ensuring smoother installation and updates for Windows users.
</details>
